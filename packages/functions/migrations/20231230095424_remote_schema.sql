...
CREATE TABLE IF NOT EXISTS "public"."card_in_tower" (
    "id" bigint NOT NULL,
    "created_at" timestamp with time zone DEFAULT "now"() NOT NULL,
...
ALTER TABLE "public"."card_in_tower" ALTER COLUMN "id" ADD GENERATED BY DEFAULT AS IDENTITY (
    SEQUENCE NAME "public"."Card_in_deck_id_seq"
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
CREATE TABLE IF NOT EXISTS "public"."card_tower" (
    "id" bigint NOT NULL,
    "created_at" timestamp with time zone DEFAULT "now"() NOT NULL,
...
CREATE TABLE IF NOT EXISTS "public"."card_in_board_deck" (
    "id" bigint NOT NULL,
    "created_at" timestamp with time zone DEFAULT "now"() NOT NULL,
    "board_id" bigint
);
...
CREATE TABLE IF NOT EXISTS "public"."card_in_board_discard_deck" (
    "id" bigint NOT NULL,
    "created_at" timestamp with time zone DEFAULT "now"() NOT NULL,
    "board_id" bigint NOT NULL,
    "card_number" smallint NOT NULL
...
CREATE TABLE IF NOT EXISTS "public"."user_in_lobby" (
    "id" bigint NOT NULL,
    "created_at" timestamp with time zone DEFAULT "now"() NOT NULL,
    "user_id" "uuid" NOT NULL
);
...
ALTER TABLE ONLY "public"."card_in_tower"
    ADD CONSTRAINT "Card_in_deck_card_number_key" UNIQUE ("card_number");

ALTER TABLE ONLY "public"."card_in_tower"
    ADD CONSTRAINT "Card_in_deck_pkey" PRIMARY KEY ("id");
...
CREATE POLICY "Enable read access for all users" ON "public"."card_in_tower" FOR SELECT TO "authenticated" USING (true);
...
GRANT ALL ON SEQUENCE "public"."Card_in_deck_id_seq" TO "anon";
GRANT ALL ON SEQUENCE "public"."Card_in_deck_id_seq" TO "authenticated";
GRANT ALL ON SEQUENCE "public"."Card_in_deck_id_seq" TO "service_role";
